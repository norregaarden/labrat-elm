...
var $author$project$Pages$Spil$Count$Click = function (a) {
	return {$: 'Click', a: a};
};
var $author$project$Pages$Spil$Count$Clicked = {$: 'Clicked'};
				...
				_Utils_ap(
					...
					_List_fromArray(
						[
							...
							$author$project$Pages$Spil$Count$Click(no)),
							$mdgriffith$elm_ui$Element$Events$onMouseUp($author$project$Pages$Spil$Count$Clicked),
							$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
							$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill)
						])),
				A2(
...
var $author$project$Pages$Spil$Count$svgCircle = function (n) {
	var colors = $elm$core$Array$fromList(
		_List_fromArray(
			['#A65E2E', '#E55137', '#D36E70', '#57A639', '#F80000', '#B32821', '#3D642D', '#C93C20', '#8A6642', '#84C3BE', '#6A5F31', '#E4A010', '#9E9764', '#6D3F5B', '#424632', '#B8B799', '#35682D']));
	var fill = A2(
		$elm$core$Maybe$withDefault,
		'#112233',
		A2(
