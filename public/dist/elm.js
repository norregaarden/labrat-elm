...
var $author$project$Gen$Route$Spil__Blink = {$: 'Spil__Blink'};
...
var $author$project$Gen$Params$Spil$Blink$parser = A2(
	$elm$url$Url$Parser$slash,
	$elm$url$Url$Parser$s('spil'),
	$elm$url$Url$Parser$s('blink'));
...
var $author$project$Gen$Route$routes = _List_fromArray(
	[
		...
		A2($elm$url$Url$Parser$map, $author$project$Gen$Route$Spil__Blink, $author$project$Gen$Params$Spil$Blink$parser),
...
var $author$project$Gen$Model$Spil__Blink = F2(
	function (a, b) {
		return {$: 'Spil__Blink', a: a, b: b};
	});
var $author$project$Gen$Msg$Spil__Blink = function (a) {
	return {$: 'Spil__Blink', a: a};
};
...
var $author$project$Pages$Data$JsonLoaded = function (a) {
	return {$: 'JsonLoaded', a: a};
};
var $author$project$Pages$Data$JsonSelected = function (a) {
			...
			return $elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'expectedDuration_ms',
						$elm$json$Json$Encode$int(s.expectedDuration_ms)),
						_Utils_Tuple2(
						'realDuration_ms',
						$elm$json$Json$Encode$int(s.realDuration_ms))
					]));
	}
};
...
var $author$project$Spil$Scores = F4(
	function (dut, tid, husk, blink) {
		return {blink: blink, dut: dut, husk: husk, tid: tid};
	});
...
var $author$project$Spil$Score_Blink = F2(
	function (expectedDuration_ms, realDuration_ms) {
		return {expectedDuration_ms: expectedDuration_ms, realDuration_ms: realDuration_ms};
	});
var $author$project$Storage$scoreBlinkDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Spil$Score_Blink,
	A2($elm$json$Json$Decode$field, 'expectedDuration_ms', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'realDuration_ms', $elm$json$Json$Decode$int));
...
var $author$project$Storage$dictScoresDecoder = A5(
	$elm$json$Json$Decode$map4,
	...
	A2(
		$elm$json$Json$Decode$field,
		'blink',
		$elm$json$Json$Decode$nullable($author$project$Storage$scoreBlinkDecoder)));
...
var $author$project$Storage$uploadJson = function (jsonstr) {
	var result = A2($elm$json$Json$Decode$decodeString, $author$project$Storage$decoder, jsonstr);
	var dothis = function () {
		if (result.$ === 'Ok') {
			var value = result.a;
			return $author$project$Storage$save(
				$author$project$Storage$toJson(value));
		} else {
			var error = result.a;
	...
	return $elm$core$Platform$Cmd$batch(
		_List_fromArray(
			[dothis, $elm$browser$Browser$Navigation$reload]));
};
			...
			case 'JsonRequested':
				return _Utils_Tuple2(
					...
					A2(
						...
						_List_fromArray(
							['text/json']),
						$author$project$Pages$Data$JsonSelected));
			case 'JsonSelected':
				var file = msg.a;
				return _Utils_Tuple2(
					model,
					A2(
						$elm$core$Task$perform,
						$author$project$Pages$Data$JsonLoaded,
						$elm$file$File$toString(file)));
			default:
				var content = msg.a;
				return _Utils_Tuple2(
					model,
					$author$project$Storage$uploadJson(content));
		}
	});
var $author$project$Pages$Data$DownloadData = {$: 'DownloadData'};
var $author$project$Pages$Data$JsonRequested = {$: 'JsonRequested'};
...
var $author$project$Pages$Data$dataMetaData = function (shared) {
	return 'data (' + ($elm$core$String$fromInt(
		$elm$core$Dict$size(shared.storage.log)) + (' log entries and ' + ($elm$core$String$fromInt(
		$elm$core$Dict$size(shared.storage.playlog)) + ' plays)')));
};
...
var $author$project$Pages$Data$viewSinglePlay = F2(
	function (playEntry, baseline) {
		...
		var dutView = function () {
			...
			if (_v2.$ === 'Nothing') {
				return $mdgriffith$elm_ui$Element$text('næ');
			} else {
				var dutScore = _v2.a;
...
var $author$project$Spil$Blink = {$: 'Blink'};
...
var $author$project$Spil$alleSpil = _List_fromArray(
	[$author$project$Spil$Dut, $author$project$Spil$Tid, $author$project$Spil$Husk, $author$project$Spil$Blink]);
		...
		function (spil, acc) {
			var tekst = function () {
				switch (spil.$) {
					...
					default:
						return 'Minimal recognition time (blink)';
				}
			}();
			return A2(
				$elm$core$List$cons,
			...
			body: $elm$core$List$singleton(
				A2(
					...
					_List_fromArray(
						[
							$author$project$UI$p(
							'Your ' + ($author$project$Pages$Data$dataMetaData(shared) + ' is only stored on this device.')),
							$author$project$UI$p('You can download your data from this device as .json:'),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$centerX]),
							...
							$mdgriffith$elm_ui$Element$text(''),
							$mdgriffith$elm_ui$Element$text(''),
							$author$project$UI$p('If you have downloaded your data as .json from another device, you can upload to this device:'),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$centerX]),
							A2($author$project$UI$smallAppButton, $author$project$Pages$Data$JsonRequested, 'Upload data')),
							$author$project$UI$p(
							'This will overwrite the ' + ($author$project$Pages$Data$dataMetaData(shared) + ' you see above.')),
							$author$project$UI$p('None of your data is uploaded to a server.'),
							$mdgriffith$elm_ui$Element$text(''),
							$mdgriffith$elm_ui$Element$text('')
						]))),
			title: 'data | lab rat'
...
var $author$project$Dutter$Blå = {$: 'Blå'};
var $author$project$Dutter$Grøn = {$: 'Grøn'};
var $author$project$Dutter$Gul = {$: 'Gul'};
var $author$project$Dutter$Rød = {$: 'Rød'};
var $author$project$Dutter$alleFarver = _List_fromArray(
	[$author$project$Dutter$Rød, $author$project$Dutter$Gul, $author$project$Dutter$Grøn, $author$project$Dutter$Blå]);
...
var $author$project$Dutter$dutHøjdeStr = $elm$core$String$fromInt($author$project$Dutter$dutHøjde);
var $author$project$Dutter$dutViewbox = '0 0 ' + ($author$project$Dutter$dutBreddeStr + (' ' + $author$project$Dutter$dutHøjdeStr));
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$author$project$UI$s(3)),
					$mdgriffith$elm_ui$Element$htmlAttribute(
					$elm$html$Html$Attributes$id('blinkImage')),
					$mdgriffith$elm_ui$Element$htmlAttribute(
					A2($elm$html$Html$Attributes$style, 'opacity', '0.001'))
				]),
			igang.jsImage));
	return _List_fromArray(
		[content]);
};
var $author$project$Pages$Spil$Blink$vis = F2(
		...
		switch (model.$) {
			case 'Intro':
				return _List_fromArray(
					[
						...
						'An image will blink ' + ($elm$core$String$fromInt($author$project$Pages$Spil$Blink$blinkTimes) + ' times for a short amount of time.')),
						$author$project$UI$small('Afterwards, click the corresponding image.'),
						$mdgriffith$elm_ui$Element$text(''),
						A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
			...
			case 'Død':
				...
				return _List_fromArray(
					[
						overskrift,
						A3($author$project$Spil$videreButton, sharedPlaying, $author$project$Pages$Spil$Blink$Videre, $author$project$Pages$Spil$Blink$OK)
					]);
			default:
				var string = model.a;
				return $elm$core$List$singleton(
...
var $author$project$Pages$Spil$Blink$view = F2(
	function (shared, model) {
		return {
			body: A2($author$project$Pages$Spil$Blink$vis, shared.playing, model),
			title: $author$project$UI$spilTitel('blink')
		};
	});
...
var $author$project$Dutter$enDut = _Utils_Tuple2($author$project$Dutter$Grøn, $author$project$Dutter$Sekskant);
var $author$project$Pages$Spil$Dut$init = _Utils_Tuple2(
	{dutterne: _List_Nil, færdig: false, igang: false, klikket: _List_Nil, tidspunkt: 0, udvalgtDut: $author$project$Dutter$enDut},
	$author$project$Effect$none);
...
var $author$project$Pages$Spil$Dut$update = F2(
	function (msg, model) {
		var udvælg = A2(
			$elm$random$Random$generate,
			$author$project$Pages$Spil$Dut$Udvælg,
		...
		switch (msg.$) {
			...
			case 'Blandet':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{dutterne: liste}),
					$author$project$Effect$fromCmd(udvælg));
			case 'Udvælg':
				var whatevs = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'Gem':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{færdig: alleRunder, igang: !alleRunder, klikket: nyKlikket}),
					effect);
			case 'Videre':
				return _Utils_Tuple2(
					model,
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A3($author$project$Spil$videreButton, sharedPlaying, $author$project$Pages$Spil$Dut$Videre, $author$project$Pages$Spil$Dut$Nå)
						]))
				]));
	});
...
var $author$project$Pages$Spil$Husk$Død = function (a) {
	return {$: 'Død', a: a};
};
				...
				switch (msg.$) {
					...
					case 'Dum':
						...
						return (_Utils_cmp(newFejl, $author$project$Pages$Spil$Husk$maxMistakes) < 0) ? _Utils_Tuple2(
							...
							$author$project$Pages$Spil$Husk$Død(newIgang),
							$author$project$Effect$none);
					default:
						return _Utils_Tuple2(
...
var $author$project$Pages$Spil$Tid$Model = F4(
	function (start, slut, igang, færdig) {
		return {færdig: færdig, igang: igang, slut: slut, start: start};
	});
...
var $author$project$Pages$Spil$Tid$Nå = {$: 'Nå'};
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[$mdgriffith$elm_ui$Element$centerX]),
								A3($author$project$Spil$videreButton, sharedPlaying, $author$project$Pages$Spil$Tid$Videre, $author$project$Pages$Spil$Tid$Nå))
							]))
					])));
...
var $author$project$Pages$Home_$vis = _List_fromArray(
	[
		...
		{description: 'rottefyr', src: '/images/rottefyr.webp'}),
		$mdgriffith$elm_ui$Element$text(''),
		A2(
		$mdgriffith$elm_ui$Element$newTabLink,
		_List_fromArray(
		...
		{
			label: $mdgriffith$elm_ui$Element$text('What is this? Click here for a video.'),
			url: 'https://youtu.be/P9_LxDqkaZM'
		}),
		$mdgriffith$elm_ui$Element$text(''),
		$mdgriffith$elm_ui$Element$text(''),
		A2(
			...
			]),
		{
			...
			url: 'https://reddit.com/r/labratapp'
		}),
		$author$project$UI$small('version 0.1.3'),
		$author$project$UI$small('updated 22-01-31'),
		A2(
		$mdgriffith$elm_ui$Element$newTabLink,
		_List_fromArray(
			[
...
var $author$project$Gen$Pages$pages = {
	...
	spil__blink: A3($author$project$Gen$Pages$bundle, $author$project$Pages$Spil$Blink$page, $author$project$Gen$Model$Spil__Blink, $author$project$Gen$Msg$Spil__Blink),
...
var $author$project$Gen$Pages$init = function (route) {
	switch (route.$) {
		...
		case 'Spil__Blink':
			return $author$project$Gen$Pages$pages.spil__blink.init(_Utils_Tuple0);
		case 'Spil__Dut':
...
var $author$project$Gen$Pages$subscriptions = function (model_) {
	switch (model_.$) {
		...
		case 'Spil__Blink':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.spil__blink.subscriptions, params, model);
		case 'Spil__Dut':
			var params = model_.a;
			var model = model_.b;
	...
	function (msg_, model_) {
		...
		while (true) {
			switch (_v0.a.$) {
				...
				case 'Spil__Blink':
					if (_v0.b.$ === 'Spil__Blink') {
						var msg = _v0.a.a;
						var _v9 = _v0.b;
						var params = _v9.a;
						var model = _v9.b;
						return A3($author$project$Gen$Pages$pages.spil__blink.update, params, msg, model);
					} else {
						break _v0$12;
					}
				case 'Spil__Dut':
...
var $author$project$Shared$initPlaying = {
	games: _List_Nil,
	scores: A4($author$project$Spil$Scores, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing)
};
...
var $author$project$Spil$spilRoute = function (spil) {
	switch (spil.$) {
		...
		default:
			return $author$project$Gen$Route$Spil__Blink;
	}
};
		...
		switch (score.$) {
			...
			default:
				return A2(
					$elm$core$List$filter,
					function (g) {
						return !_Utils_eq(g, $author$project$Spil$Blink);
					},
					games);
		}
	});
		...
		switch (_new.$) {
			...
			default:
				...
				return _Utils_update(
					scores,
					{
						blink: $elm$core$Maybe$Just(score)
					});
		}
	});
				...
				A2(
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
							$mdgriffith$elm_ui$Element$width(
							A2($mdgriffith$elm_ui$Element$maximum, 666, $mdgriffith$elm_ui$Element$fill)),
							$mdgriffith$elm_ui$Element$centerX
						]),
					_Utils_ap(
						_List_fromArray(
...
var $author$project$Gen$Pages$view = function (model_) {
	switch (model_.$) {
		...
		case 'Spil__Blink':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.spil__blink.view, params, model);
		case 'Spil__Dut':
			var params = model_.a;
			var model = model_.b;
