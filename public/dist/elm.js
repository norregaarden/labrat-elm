...
var $author$project$Gen$Route$Spil__Count = {$: 'Spil__Count'};
...
var $author$project$Gen$Params$Spil$Count$parser = A2(
	$elm$url$Url$Parser$slash,
	$elm$url$Url$Parser$s('spil'),
	$elm$url$Url$Parser$s('count'));
...
var $author$project$Gen$Route$routes = _List_fromArray(
	[
		...
		A2($elm$url$Url$Parser$map, $author$project$Gen$Route$Spil__Count, $author$project$Gen$Params$Spil$Count$parser),
...
var $author$project$Gen$Model$Spil__Count = F2(
	function (a, b) {
		return {$: 'Spil__Count', a: a, b: b};
	});
var $author$project$Gen$Msg$Spil__Count = function (a) {
	return {$: 'Spil__Count', a: a};
};
...
var $author$project$Pages$Spil$Count$Intro = {$: 'Intro'};
var $author$project$Pages$Spil$Count$init = _Utils_Tuple2($author$project$Pages$Spil$Count$Intro, $author$project$Effect$none);
var $author$project$Pages$Spil$Count$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
...
var $author$project$Pages$Spil$Count$igangInit = {blandet: _List_Nil, clicked: -1, correct: false};
			...
			return $author$project$Effect$fromCmd(
				A2(
					...
					A2(
						...
						$author$project$Pages$Spil$Count$Blandet),
					A2(
						$elm$random$Random$andThen,
						$elm_community$random_extra$Random$List$shuffle,
						$elm_community$random_extra$Random$Extra$combine(
							A2(
								$elm$core$List$map,
								function (i) {
									return A2(
				...
				if (model.$ === 'Igang') {
					...
					var correctCount = A2(
						...
						$elm$core$List$maximum(
							A2($elm$core$List$map, $elm$core$Set$size, igangModel.blandet)));
					...
					return _Utils_Tuple2(
						$author$project$Pages$Spil$Count$Igang(
							_Utils_update(
								...
								{
									clicked: no,
									correct: _Utils_eq(correctCount, actualCount)
								})),
						$author$project$Effect$none);
				} else {
...
var $author$project$Pages$Spil$Count$Begynd = {$: 'Begynd'};
var $author$project$Pages$Spil$Count$Klik = function (a) {
	return {$: 'Klik', a: a};
};
var $author$project$UIColor$green = A3($mdgriffith$elm_ui$Element$rgb255, 10, 147, 150);
var $author$project$Pages$Spil$Count$fourSquares = F3(
	function (list, pressed, correct) {
		var greenBorder = function (no) {
			return _Utils_eq(no, pressed) ? _List_fromArray(
				[
					correct ? $mdgriffith$elm_ui$Element$Border$color($author$project$UIColor$green) : $mdgriffith$elm_ui$Element$Border$color($author$project$UIColor$red)
				]) : _List_Nil;
		};
		var array = $elm$core$Array$fromList(list);
		var square = function (no) {
			return A2(
				$mdgriffith$elm_ui$Element$el,
				_Utils_ap(
					greenBorder(no),
					_List_fromArray(
						[
							...
							$author$project$UI$s(3)),
							$mdgriffith$elm_ui$Element$Events$onClick(
							$author$project$Pages$Spil$Count$Klik(no)),
							$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
							$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill)
						])),
				A2(
					...
					A2($elm$core$Array$get, no, array)));
		};
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
...
var $author$project$Pages$Spil$Count$svgCircle = $mdgriffith$elm_ui$Element$html(
	A2(
		$elm$svg$Svg$svg,
		_List_fromArray(
			[
		...
		$elm$core$List$singleton(
			A2(
				...
				_List_Nil))));
var $author$project$Pages$Spil$Count$visBoks = function (numbers) {
	var visDims = function (n) {
		return A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
					$mdgriffith$elm_ui$Element$alpha(
					A2($elm$core$Set$member, n, numbers) ? 1 : 0)
				]),
			$author$project$Pages$Spil$Count$svgCircle);
	};
	var boksRow = function (r) {
		return A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
				[
			...
			A2(
				$elm$core$List$map,
				visDims,
				A2($elm$core$List$range, r * 5, (r * 5) + 4)));
	};
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
...
var $author$project$Pages$Spil$Count$view = F2(
	function (shared, model) {
		return {
			body: A2($author$project$Pages$Spil$Count$vis, shared.playing, model),
			title: $author$project$UI$spilTitel('count')
		};
	});
var $author$project$Pages$Spil$Count$page = F2(
	function (shared, req) {
		return $author$project$Page$advanced(
			{
				init: $author$project$Pages$Spil$Count$init,
				subscriptions: $author$project$Pages$Spil$Count$subscriptions,
				update: $author$project$Pages$Spil$Count$update,
				view: $author$project$Pages$Spil$Count$view(shared)
			});
	});
...
var $author$project$Gen$Pages$pages = {
	...
	spil__count: A3($author$project$Gen$Pages$bundle, $author$project$Pages$Spil$Count$page, $author$project$Gen$Model$Spil__Count, $author$project$Gen$Msg$Spil__Count),
...
var $author$project$Gen$Pages$init = function (route) {
	switch (route.$) {
		...
		case 'Spil__Count':
			return $author$project$Gen$Pages$pages.spil__count.init(_Utils_Tuple0);
		case 'Spil__Dut':
...
var $author$project$Gen$Pages$subscriptions = function (model_) {
	switch (model_.$) {
		...
		case 'Spil__Count':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.spil__count.subscriptions, params, model);
		case 'Spil__Dut':
			var params = model_.a;
			var model = model_.b;
	...
	function (msg_, model_) {
		...
		while (true) {
			switch (_v0.a.$) {
				...
				case 'Spil__Count':
					if (_v0.b.$ === 'Spil__Count') {
						var msg = _v0.a.a;
						var _v9 = _v0.b;
						var params = _v9.a;
						var model = _v9.b;
						return A3($author$project$Gen$Pages$pages.spil__count.update, params, msg, model);
					} else {
						break _v0$12;
					}
				case 'Spil__Dut':
...
var $author$project$Gen$Pages$view = function (model_) {
	switch (model_.$) {
		...
		case 'Spil__Count':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.spil__count.view, params, model);
		case 'Spil__Dut':
			var params = model_.a;
			var model = model_.b;
